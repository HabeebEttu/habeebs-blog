...
export default function ExploreTopics() {
  ...
  return (
    <div className="flex flex-col p-6 bg-gray-100 dark:bg-gray-800 min-h-[20rem] w-full py-12">
      <h1 className="text-center font-bold text-3xl text-black dark:text-white mt-3">
        Explore Topics
      </h1>
